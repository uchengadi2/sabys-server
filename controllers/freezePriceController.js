...
const FreezePrice = require("./../models/FreezePriceModel");
...
//the handler to get all FreezePrice
exports.getAllFreezePrices = factory.getAll(FreezePrice);

//the handler to create a FreezePrice
exports.createFreezePrice = factory.createOne(FreezePrice);

//the handler to get one FreezePrice
exports.getFreezePrice = factory.getOne(FreezePrice);

//the handler to update a FreezePrice
exports.updateFreezePrice = factory.updateOne(FreezePrice);

//the handler to delete a FreezePrice
exports.deleteFreezePrice = factory.deleteOne(FreezePrice);
